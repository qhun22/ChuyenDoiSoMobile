...
export default function ProductDetailManagement({
  ...
  return (
    <div className="w-full space-y-4 font-['Signika',sans-serif]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200/60 bg-white p-3.5 rounded-xl border border-slate-100 shadow-2xs">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onBack}
            className="h-8 px-3 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer"
          >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-base sm:text-lg font-black text-slate-900 tracking-wide">
                {product.name}
              </h1>
              <span className="px-2 py-0.5 rounded bg-slate-100 text-slate-700 font-bold text-[10px] tracking-wide">
                {product.brand}
              </span>
            </div>
          </div>
